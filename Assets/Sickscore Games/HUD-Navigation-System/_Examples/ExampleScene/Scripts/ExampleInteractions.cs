...
public class ExampleInteractions : MonoBehaviour
{
	...
	/// 封装小地图交互方法 
	/// </summary>
	/// <param name="isAdd">是否为小地图扩大视野</param>
	public void MiniMapInteraction(bool isAdd)
	{
		if (isAdd && _HUDNavigationSystem.minimapScale < 1f)
		{
			_HUDNavigationSystem.minimapScale += .03f;
		}
		else if(!isAdd  && _HUDNavigationSystem.minimapScale > .06f)
		{
			_HUDNavigationSystem.minimapScale -= .03f;
		}
	}
